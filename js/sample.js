...
var input = [
    {id: "test", type: "text", name: "Imie", description: "Jakis opis", regexp: /^[a-zA-Z]*[a-zA-Z]?$/, value: "Mateusz", className: "input", length: 10, minLength: 5, breakLine: false, uppercase: true},
